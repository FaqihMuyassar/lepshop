...
export const Adv2 = ( {id, title, date, image, height, width} ) => {
    return (
        ...
        <p className="text-slate-400 md:text-lg text-xs">{date}</p>
          <p className="md:text-3xl text-lg font-bold md:py-4 py-1">
            {title}
          </p>
          <p className="md:text-lg text-xs text-slate-400">
